...
describe('Import', function() {
  ...
  it('starts with no import requests in the account history', async () => {
  ...
  it('rejects malformed import requests', async () => {
    let response = await server.inject({
      method: 'POST',
      url: '/import',
      headers: { 'Authorization': `Bearer ${token}` },
  ...
  it('rejects import with children with null titles', async () => {
    let response = await server.inject({
      method: 'POST',
      url: '/import',
      headers: { 'Authorization': `Bearer ${token}` },
